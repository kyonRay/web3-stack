...
| [eip-and-upgrades.md](./eip-and-upgrades.md) | 关键 EIP 索引：EIP-1559、EIP-4844、EIP-4337、EIP-7702、以太坊升级路线 |
| [eth/eip/README.md](./eth/eip/README.md) | **EIP 深度解析目录**：10 个关键 EIP 的完整分析，含 Pectra / Fusaka 升级详情 |
...
5. 了解 [eip-and-upgrades.md](./eip-and-upgrades.md) — 重要 EIP 速览与路线图
6. 深入 [eth/eip/](./eth/eip/) — 关键 EIP 深度解析（London → Shanghai → Dencun → Pectra → Fusaka）
7. 按需学习 [substrate-cosmos.md](./substrate-cosmos.md) — 其他框架
